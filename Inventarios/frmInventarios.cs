...
namespace Inventarios
{
    public partial class frmInventarios : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (lvEntradas.Items.Count != null)
            {
                if (cboInventario.SelectedItem == "UEPS")
                {
                    ...
                    if (cboMovimiento.SelectedItem == "Entrada")
                    {
                        ...
                        ListViewItem salida = new ListViewItem("0");
                        salida.SubItems.Add("0");
                        salida.SubItems.Add("0");
                    ...
                    else if (cboMovimiento.SelectedItem == "Salida")
                    {
                        ...
                        if (double.Parse(txtCantidad.Text) <= conver11)
                        {
                            ...
                            ListViewItem entrada = new ListViewItem("0");
                            entrada.SubItems.Add("0");
                            entrada.SubItems.Add("0");
                            lvEntradas.Items.Add(entrada);
                        ...
                        if (double.Parse(txtCantidad.Text) > conver11)
                        {
                            ...
                            if (double.Parse(txtCantidad.Text) < SumaDosUlltimos)
                            {
                                ...
                                ListViewItem saldos = new ListViewItem("0");
                                saldos.SubItems.Add("0");
                                saldos.SubItems.Add("0");
                                lvSaldos.Items.Add(saldos);
                                ...
                                ListViewItem entrada2 = new ListViewItem("0");
                                entrada2.SubItems.Add("0");
                                entrada2.SubItems.Add("0");
                ...
                else if (cboInventario.SelectedItem == "PEPS")
                {
                    ...
                    else if (cboMovimiento.SelectedItem == "Salida")
                    {
                        ...
                        else if (double.Parse(txtCantidad.Text) > valor11)
                        {
                            ...
                            ListViewItem saldo = new ListViewItem("0");
                            saldo.SubItems.Add("0");
                            saldo.SubItems.Add("0");
                ...
                MessageBox.Show("No puede ingresar una salida, sino hay mas de una entrada", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void ExportarListViewAExcel(System.Windows.Forms.ListView fechaListView, System.Windows.Forms.ListView entradasListView, System.Windows.Forms.ListView salidasListView, System.Windows.Forms.ListView saldosListView, Worksheet objHoja, int inicioRow, int inicioColumn)
        {
            ...
            if (cboInventario.SelectedItem == "UEPS" || cboInventario.SelectedItem == "PEPS" || cboInventario.SelectedItem == "Promedio")
            {
                for (int i = 0; i < fechaListView.Items.Count; i++)
                {
                    ...
                    {
                        objHoja.Cells[rowActual, inicioColumn + 3 + col].Value = entradasListView.Items[i].SubItems[col].Text;
                        objHoja.Cells[rowActual, inicioColumn + 6 + col].Value = salidasListView.Items[i].SubItems[col].Text;
                        objHoja.Cells[rowActual, inicioColumn + 9 + col].Value = saldosListView.Items[i].SubItems[col].Text;
                    }
        ...
        {
            if (cboMovimiento.SelectedItem == "Salida" && cboMovimiento.SelectedItem == "Entrada")
            {
                txtCantidad.Clear();
                txtValorUnit.Clear();
            }
